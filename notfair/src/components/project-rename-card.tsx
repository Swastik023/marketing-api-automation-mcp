      ...
      <div className="space-y-3 p-[18px]">
        <div>
          ...
          <p className="mt-1 text-[12.5px] leading-snug text-[hsl(var(--notfair-ink-4))]">
            Changing the slug renames every agent, moves
            workspace dirs, and relocates sessions.
          </p>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            disabled={pending}
            className={cn(
              "h-9 w-full rounded-lg bg-[hsl(var(--notfair-surface-2))] px-3 text-[13.5px] tracking-tight focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--notfair-accent-border))]",
