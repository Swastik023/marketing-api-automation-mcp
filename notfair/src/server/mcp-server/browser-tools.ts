...
// This matters because NotFair runs agents under Codex CLI / Claude
...
const ROUTING_PREAMBLE =
  "This is the ONLY browser tool that drives the NotFair workspace browser " +
  "(persistent profile at ~/.notfair/projects/<slug>/browser/, shared by " +
