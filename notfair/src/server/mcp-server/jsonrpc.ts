...
/**
 * JSON-RPC 2.0 dispatcher for NotFair's outbound MCP servers.
 *
 * Each MCP server endpoint (e.g. /api/mcp/goals, /api/mcp/browser)
...
export interface McpServerInfo {
  /** Server name reported in `initialize`. Should match the MCP registration key (e.g. "notfair-goals"). */
  name: string;
