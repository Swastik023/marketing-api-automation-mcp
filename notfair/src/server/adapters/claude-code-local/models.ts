...
const ALIAS_TIERS: HarnessModelOption[] = [
  // context_window: documented tier windows (Anthropic docs); the CLI
  // exposes no model-metadata surface to read them from.
  { value: "fable", label: "Fable", context_window: 200_000 },
  { value: "opus", label: "Opus", context_window: 200_000 },
  { value: "sonnet", label: "Sonnet", context_window: 200_000 },
  { value: "haiku", label: "Haiku", context_window: 200_000 },
];
