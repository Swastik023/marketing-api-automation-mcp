...
/**
 * PROJECT.md — the shared workspace context: "what is this project / who
 * is the company". Any goal agent can update it via the
 * `set_shared_context` tool; it propagates into every agent's IDENTITY.md
 * so all goals share the same picture.
 *
 * Path layout (relative to the data dir, default ~/.notfair):
 *
 *   projects/<slug>/PROJECT.md  — canonical shared copy
 *
 ...
 * regardless of which files the harness chooses to load.
 */
