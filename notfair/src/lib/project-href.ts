/**
 * Build a project-scoped URL like `/<slug>/goals/goal-1`.
 *
 ...
 * normalisation so callers can pass either `goals/goal-1` or `/goals/goal-1`.
 *
 ...
 * preserves the user's current view (`/foo/connections` → `/connections`).
 *
